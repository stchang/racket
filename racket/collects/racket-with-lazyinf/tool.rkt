...
(define (racket-with-lazyinf-unit-frame-mixin super%)
  (class super%
...
;          (when (string=? "racket-with-lazyinf" (get-text 6 (sub1 pos)))
...
(define (racket-with-lazyinf-def-txt-mixin super%)
  (class super%
...
(define-unit tool@
  ...
  (define (phase1) 
    (drracket:module-language-tools:add-opt-out-toolbar-button
       ...
       #:number 71))
  (define (phase2) (void))
  (drracket:get/extend:extend-unit-frame racket-with-lazyinf-unit-frame-mixin)
  (drracket:get/extend:extend-definitions-text racket-with-lazyinf-def-txt-mixin))
